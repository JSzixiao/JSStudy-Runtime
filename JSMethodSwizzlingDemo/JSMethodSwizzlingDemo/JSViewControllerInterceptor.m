...
#import "JSViewControllerInterceptor.h"
...
@implementation JSViewControllerInterceptor
...
+(void)load
{
    ...
    [JSViewControllerInterceptor sharedInstance];
...
+ (instancetype)sharedInstance
{
    ...
    static JSViewControllerInterceptor *sharedInstance;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[JSViewControllerInterceptor alloc] init];
    });
